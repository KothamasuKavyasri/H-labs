		     ...
		     $sql="select * from register where mail='$_SESSION[mail]'";
			   if($res=mysqli_query($con,$sql))
			   {
				   if(mysqli_num_rows($res))
				   {
					   ...
					   {
						   $fid=$row['fid'];
						   echo '<img class="img-circle imge" src="data:image/jpg;base64,'.base64_encode( $row['img1'] ).' " align="center" width="50" height="50"   data-toggle="tooltip" data-placement="bottom" title="Profile Picture"/>';
